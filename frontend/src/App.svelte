<script>
    ...
    async function makeImage() {
                ...
                if (res.status !== 'succeeded') {
                    ...
                    if (res.detail !== undefined) {
                        msg =
                            res.detail[0].msg +
                            ' in ' +
                            JSON.stringify(res.detail[0].loc);
                    } else {
                        msg = res;
                    }
                    logError(msg, res);
        ...
        outputMsg.innerHTML =
            'Processed in ' + time + ' seconds. Seed: ' + seed;
...
<main>
    ...
    <div id="status">
        Server status: <span id="serverStatus">checking..</span> | Request
        status: <span id="reqStatus">n/a</span>
    </div>
    ...
    {#if shouldDisplayConfig}
        <div id="config">
            ...
            <select
                ...
                name="num_outputs"
                value="1"
                ><option value="1" selected>1</option><option value="4"
                    >4</option
                ></select
            ><br />
            ...
            <select
                ...
                ><option value="512" selected>512</option><option value="768"
                    >768</option
                ><option value="1024">1024</option></select
            ><br />
    ...
    <div id="footer">
        <p>
            ...
            >
            or <a href="mailto:sd@cmdr2.org" target="_blank">email me</a> if you
            have any problems or suggestions in using this interface.
        </p>
        <p>
            <b>Disclaimer:</b> I am not responsible for any images generated using
            this interface.
        </p>
    </div>
</main>
